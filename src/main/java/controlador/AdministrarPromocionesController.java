...
public class AdministrarPromocionesController implements Initializable {
  ...
  @FXML
  ObservableList<Promocion> promocionest;
  @FXML
  private Label label;
  @FXML
  ...
  @FXML
  private TableColumn<Promocion, String> tcFechaInicio;
  @FXML
  private TableColumn<Promocion, String> tcFechaFin;
  @FXML
  private TableColumn<Promocion, String> tcDescripcion;
  @FXML
  private TableColumn<Promocion, String> tcIdPromocion;
  ...
  @FXML
  private JFXTextField tfDescuento;
  @FXML
  ...
  private void guardarCambiosPromocion(ActionEvent event) {
    ...
    int idPromocion = (tablaPromociones.getSelectionModel().getSelectedItem().getId());
