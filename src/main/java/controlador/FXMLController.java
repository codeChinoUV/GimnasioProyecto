...
public class FXMLController implements Initializable {
 ...
 /*   private void ventanaAgregarPromocion(ActionEvent e) throws IOException{
        
        Parent root = FXMLLoader.load(getClass().getResource("/fxml/agregarPromocion.fxml"));
        Scene scene = new Scene(root);
        scene.getStylesheets().add("/styles/Styles.css");
        Stage stage = new Stage();
        stage.setTitle("Registro de Promociones");
        stage.setScene(scene);
        stage.show(); 
    }*/
 /*   public void mostrarVentanaRegistro(ActionEvent event) throws Exception {    
     try { 
       System.out.println("no lo obtine");
       Parent root = FXMLLoader.load(getClass().getResource("/fxml/agregarPromocion.fxml")); 
       System.out.println("problema al cargarlo");
        
       System.out.println("no llega al stage");
       Stage stage = new Stage(); 
       System.out.println("aqui prmero");
       stage.setScene(new Scene(root)); 
       System.out.println("aqui paso alfo");
       stage.show(); 
     } catch(Exception e) { 
      e.printStackTrace(); 
      } 
